...
export class CarService {
  ...
  public getAllReps(carId:any): Observable<any[]> {
    return this.http.get<any[]>(`${this.apiServerUrl}/car/repa/${carId}`);
  }
  public saveDataRep(car: any): Observable<any> {
    return this.http.post<any>(this.apiServerUrl + '/car/repa/guardar', car);
  }
}